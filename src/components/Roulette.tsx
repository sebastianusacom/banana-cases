...
export const Roulette: React.FC<RouletteProps> = ({
  ...
  const getSizeConfig = (m: number) => {
    switch(m) {
      case 1: return { card: 140, image: 'w-32 h-32', star: 20, font: 'text-lg', padding: 'px-3 py-1.5' };
      case 2: return { card: 120, image: 'w-28 h-28', star: 14, font: 'text-sm', padding: 'px-3 py-1' };
